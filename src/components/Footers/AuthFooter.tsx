        ...
        <Row className="align-items-center justify-content-xl-between">
          ...
          <Col xl="6">
            <Nav className="nav-footer justify-content-center justify-content-xl-end">
              <NavItem>
                <NavLink href="https://www.creative-tim.com?ref=njsad-auth-footer" target="_blank">
                  Creative Tim
                </NavLink>
              </NavItem>
              <NavItem>
              ...
              <NavItem>
                <NavLink href="http://blog.creative-tim.com?ref=njsad-auth-footer" target="_blank">
                  Blog
                </NavLink>
              </NavItem>
              <NavItem>
